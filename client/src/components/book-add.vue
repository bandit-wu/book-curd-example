<template>
  ...
  >
    ...
    <el-row>
      ...
      <el-col :span="20">
        <el-input v-model="bookInfo.name" size="medium"></el-input>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="4">
      ...
      <el-col :span="20">
        <el-input v-model="bookInfo.isbn" size="medium"></el-input>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="4">
      ...
      <el-col :span="20">
        <el-input v-model="bookInfo.author" size="medium"></el-input>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="4">
      ...
      <el-col :span="20">
        <el-input v-model="bookInfo.print" size="medium"></el-input>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="4">
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="addBook" size="medium">确 定</el-button>
    </div>
  </el-dialog>
</template>
<script>
